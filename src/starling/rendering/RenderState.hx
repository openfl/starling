...
class RenderState {
	...
	private static function __init__() {
		untyped Object.defineProperties(RenderState.prototype, {
			"modelviewMatrix": {get: untyped __js__("function () { return this.get_modelviewMatrix (); }"),
				set: untyped __js__("function (v) { return this.set_modelviewMatrix (v); }")},
			"modelviewMatrix3D": {get: untyped __js__("function () { return this.get_modelviewMatrix3D (); }"),
				set: untyped __js__("function (v) { return this.set_modelviewMatrix3D (v); }")},
			"projectionMatrix3D": {get: untyped __js__("function () { return this.get_projectionMatrix3D (); }"),
				set: untyped __js__("function (v) { return this.set_projectionMatrix3D (v); }")},
			"mvpMatrix3D": {get: untyped __js__("function () { return this.get_mvpMatrix3D (); }"),
				set: untyped __js__("function (v) { return this.set_mvpMatrix3D (v); }")},
			...
			"renderTarget": {get: untyped __js__("function () { return this.get_renderTargete (); }"),
				set: untyped __js__("function (v) { return this.set_renderTarget (v); }")},
			"renderTargetBase": {get: untyped __js__("function () { return this.get_renderTargetBase (); }")},
			"culling": {get: untyped __js__("function () { return this.get_culling (); }"),
				set: untyped __js__("function (v) { return this.set_culling (v); }")},
			"depthMask": {get: untyped __js__("function () { return this.get_depthMask (); }"),
				set: untyped __js__("function (v) { return this.set_depthMask (v); }")},
			"depthTest": {get: untyped __js__("function () { return this.get_depthTest (); }"),
				set: untyped __js__("function (v) { return this.set_depthTest (v); }")},
			"clipRect": {get: untyped __js__("function () { return this.get_clipRect (); }"),
				set: untyped __js__("function (v) { return this.set_clipRect (v); }")},
			...
			"onDrawRequired": {get: untyped __js__("function () { return this.get_onDrawRequired (); }"),
				set: untyped __js__("function (v) { return this.set_onDrawRequired (v); }")},
		});
	}
	#end
	...
	public function copyFrom(renderState:RenderState):Void {
		if (_onDrawRequired != null) {
			...
			var clipRectChanges:Bool = _clipRect != null
				|| renderState._clipRect != null ? !RectangleUtil.compare(_clipRect, renderState._clipRect) : false;

			if (_blendMode != renderState._blendMode || currentTarget != nextTarget || clipRectChanges || cullingChanges) {
				_onDrawRequired();
			}
		}
	 ...
	 */
	public function setProjectionMatrix(x:Float, y:Float, width:Float, height:Float, stageWidth:Float = 0, stageHeight:Float = 0,
	 ...
	 */
	public function setRenderTarget(target:Texture, enableDepthAndStencil:Bool = true, antiAlias:Int = 0):Void {
		var currentTarget:TextureBase = _renderTarget != null ? _renderTarget.base : null;
	...
	private inline function get_renderTarget():Texture {
		return _renderTarget;
	}

	private inline function set_renderTarget(value:Texture):Texture {
	...
	private inline function get_renderTargetBase():TextureBase {
	...
	private inline function get_renderTargetOptions():UInt {
	...
	private inline function get_culling():String {
		var index:Int = (_miscOptions & 0xf00) >> 8;
		return CULLING_VALUES[index];
	}

	private inline function set_culling(value:String):String {
	...
	private inline function set_depthMask(value:Bool):Bool {
		if (depthMask != value) {
			if (_onDrawRequired != null)
				_onDrawRequired();
	...
	private inline function get_depthTest():String {
		var index:Int = (_miscOptions & 0x000f0000) >> 16;
		return COMPARE_VALUES[index];
	}

	private inline function set_depthTest(value:String):String {
		if (depthTest != value) {
			if (_onDrawRequired != null)
				_onDrawRequired();
	...
	private inline function get_clipRect():Rectangle {
		return _clipRect;
	}
	...
	private inline function get_renderTargetAntiAlias():Int {
	...
	private inline function get_renderTargetSupportsDepthAndStencil():Bool {
	...
	private inline function get_is3D():Bool {
	...
	private inline function get_onDrawRequired():Void->Void {
		return _onDrawRequired;
	}

	private inline function set_onDrawRequired(value:Void->Void):Void->Void {
		return _onDrawRequired = value;
	}
}
