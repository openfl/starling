...
public class Texture
{
     ...
     */
    public static function fromEmbeddedAsset(assetClass:Class, mipMapping:Bool=false,
     ...
     *  (if there is one). */
    public function get frameWidth():Float { return frame ? frame.width : width; }

    /** The width of the texture in points, taking into account the frame rectangle
     *  (if there is one). */
    public function get frameHeight():Float { return frame ? frame.height : height; }
