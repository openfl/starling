...
public class TextureOptions
{
    ...
    public function get mipMapping():Bool { return _mipMapping; }
    public function set mipMapping(value:Bool):Void { _mipMapping = value; }
    ...
    public function set premultipliedAlpha(value:Bool):Void { _premultipliedAlpha = value; }
}
}