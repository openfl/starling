...
public class RenderTexture extends SubTexture
{
    ...
    private function get isDoubleBuffered():Bool { return _bufferTexture != null; }

    /** Indicates if the texture is persistent over multiple draw calls. */
    public function get isPersistent():Bool { return _isPersistent; }
     ...
     */
    public static function get useDoubleBuffering():Bool
    {
        if (Starling.current)
        {
            var painter:Painter = Starling.painter;
    ...
    public static function set useDoubleBuffering(value:Bool):Void
    {
