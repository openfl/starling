...
class VertexDataFormat
{
    ...
    {
        var value:VertexDataFormat = sFormats[format];
    ...
    private function parseFormat(format:String):Void
    {
        ...
        {
            ArrayUtil.clear(_attributes);
            _format = "";

            var parts:Array<String> = format.split(",");
            ...
            for (i in 0 ... numParts)
            {
                ...
                var attrParts:Array<String> = attrDesc.split(":");
                ...
                var attribute:VertexDataAttribute =
                    new VertexDataAttribute(attrName, getVertexBufferFormatFromString(attrFormat), offset);
    ...
    /** @private */
    public var attributes(get, never):Array<VertexDataAttribute>;
    @:noCompletion private function get_attributes():Array<VertexDataAttribute>
    {
        return _attributes;
    }
    ...
    @:noCompletion private function get_numAttributes():Int
    {
        return _attributes.length;
    }
    
    private static function getVertexBufferFormatFromString(format:String):Context3DVertexBufferFormat
    {
