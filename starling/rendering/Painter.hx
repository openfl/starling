...
public class Painter
{
    ...
    public function get pixelSize():Float { return _pixelSize; }
    public function set pixelSize(value:Float):Void { _pixelSize = value; }
    ...
    public function get backBufferScaleFactor():Float { return _backBufferScaleFactor; }
