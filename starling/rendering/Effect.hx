...
class Effect
{
     ...
     *  @default 0
     */
    private var programVariantName(get, never):UInt;
    @:noCompletion private function get_programVariantName():UInt
    {
        return 0;
    }
    ...
    @:noCompletion private function get_programBaseName():String { return _programBaseName; }
    @:noCompletion private function set_programBaseName(value:String):String { return _programBaseName = value; }
    ...
    @:noCompletion private function get_programName():String
    {
    ...
    @:noCompletion private function get_vertexFormat():VertexDataFormat { return VERTEX_FORMAT; }

    /** The MVP (modelview-projection) matrix transforms vertices into clipspace. */
    public var mvpMatrix3D(get, set):Matrix3D;
    @:noCompletion private function get_mvpMatrix3D():Matrix3D { return _mvpMatrix3D; }
    @:noCompletion private function set_mvpMatrix3D(value:Matrix3D):Matrix3D { _mvpMatrix3D.copyFrom(value); return value; }
    ...
    @:noCompletion private function get_vertexBuffer():VertexBuffer3D { return _vertexBuffer; }
    
    /** The current size of the vertex buffer (in blocks of 32 bits). */
    private var vertexBufferSize(get, never):Int;
    @:noCompletion private function get_vertexBufferSize():Int { return _vertexBufferSize; }
}
