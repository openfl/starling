...
public class MovieClip extends Image implements IAnimatable
{
    ...
    public function MovieClip(textures:Vector.<Texture>, fps:Float=12)
    {
    ...
    public function get loop():Bool { return _loop; }
    public function set loop(value:Bool):Void { _loop = value; }
    
    /** If enabled, no new sounds will be started during playback. Sounds that are already
     *  playing are not affected. */
    public function get muted():Bool { return _muted; }
    public function set muted(value:Bool):Void { _muted = value; }
    ...
    public function get fps():Float { return 1.0 / _defaultFrameDuration; }
...
{
public function MovieClipFrame(texture:Texture, duration:Float=0.1,  startTime:Float=0)
{
