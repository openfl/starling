...
public class Event
{
    ...
    /** @private */
    internal function get stopsPropagation():Bool { return _stopsPropagation; }
    
    /** @private */
    internal function get stopsImmediatePropagation():Bool { return _stopsImmediatePropagation; }
