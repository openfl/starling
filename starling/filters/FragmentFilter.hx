...
public class FragmentFilter extends EventDispatcher
{
    ...
    public function get isCached():Bool { return _cached; }
     ...
     */
    public function get resolution():Float { return _resolution; }
     ...
     *  @default false
     */
    public function get alwaysDrawToBackBuffer():Bool { return _alwaysDrawToBackBuffer; }
    public function set alwaysDrawToBackBuffer(value:Bool):Void
    {
