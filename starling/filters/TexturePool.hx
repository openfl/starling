...
internal class TexturePool implements ITexturePool
{
    ...
    public function get textureWidth():Float { return _width; }

    /** The height of the returned textures (in points). */
    public function get textureHeight():Float { return _height; }

    /** The scale factor of the returned textures. */
    public function get textureScale():Float { return _scale; }
}
}
