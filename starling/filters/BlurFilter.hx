...
class BlurFilter extends FragmentFilter
{
    ...
    private var mOffsets:Vector<Float> = new Vector ([0.0, 0, 0, 0]);
    private var mWeights:Vector<Float> = new Vector ([0.0, 0, 0, 0]);
    private var mColor:Vector<Float>   = new Vector ([1.0, 1, 1, 1]);
    ...
    /** helper object */
    private var sTmpWeights:Vector<Float> = new Vector ([0.0, 0, 0, 0, 0]);
