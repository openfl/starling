...
public class BlurFilter extends FragmentFilter
{
    ...
    public function get blurX():Float { return _blurX; }
     ...
     *  The number of required passes will be <code>Math.ceil(value)</code>. */
    public function get blurY():Float { return _blurY; }
...
private var _offsets:Vector.<Float> = new <Float>[0, 0, 0, 0];
private var _weights:Vector.<Float> = new <Float>[0, 0, 0, 0];
...
public function get strength():Float { return _strength; }
public function set strength(value:Float):Void
{
