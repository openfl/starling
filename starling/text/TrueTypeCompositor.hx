...
class BitmapDataEx extends BitmapData
{
    ...
    public function new(width:Int, height:Int, transparent:Bool=true, fillColor:UInt=0x0)
    {
        super(width, height, transparent, fillColor);
    }

    public var scale(get, set):Float;
    @:noCompletion private function get_scale():Float { return _scale; }
    @:noCompletion private function set_scale(value:Float):Float { return _scale = value; }
}
