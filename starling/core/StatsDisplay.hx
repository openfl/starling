...
internal class StatsDisplay extends Sprite
{
    ...
    public function get fps():Float { return _fps; }
    public function set fps(value:Float):Void { _fps = value; }
    
    /** The currently required system memory in MB. */
    public function get memory():Float { return _memory; }
    public function set memory(value:Float):Void { _memory = value; }
}
}