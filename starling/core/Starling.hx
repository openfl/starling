...
public class Starling extends EventDispatcher
{
    ...
    public function dispose():Void
    {
        ...
        var numInstancesSharingThisPainter:Int =
            sAll.filter(function(s:Starling, ...rest):Bool
            {
    ...
    private function get mustAlwaysRender():Bool
    {
    ...
    public function get isStarted():Bool { return _started; }
     ...
     *  @default false */
    public function get simulateMultitouch():Bool { return _touchProcessor.simulateMultitouch; }
     ...
     *
     *  @default false */
    public function get enableErrorChecking():Bool { return _painter.enableErrorChecking; }
    ...
    public function get contentScaleFactor():Float
    {
     ...
     *  memory analysis.</p>
     */
    public function get showStats():Bool { return _showStats; }
    public function set showStats(value:Bool):Void
    {
        _showStats = value;
    ...
    public function get shareContext() : Bool { return _painter.shareContext; }
    public function set shareContext(value : Bool) : Void { _painter.shareContext = value; }
    ...
    public function get supportHighResolutions():Bool { return _supportHighResolutions; }
    public function set supportHighResolutions(value:Bool):Void 
    {
     ...
     *  @default false
     */
    public function get skipUnchangedFrames():Bool { return _skipUnchangedFrames; }
    public function set skipUnchangedFrames(value:Bool):Void
    {
     ...
     *  disposed). */
    public function get contextValid():Bool { return _painter.contextValid; }
    ...
    public static function get contentScaleFactor():Float 
    {
        return sCurrent ? sCurrent.contentScaleFactor : 1.0;
    }
    
    /** Indicates if multitouch input should be supported. */
    public static function get multitouchEnabled():Bool 
    { 
        return Multitouch.inputMode == MultitouchInputMode.TOUCH_POINT;
    }
    
    public static function set multitouchEnabled(value:Bool):Void
    {
...
function isNativeDisplayObjectEmpty(object:DisplayObject):Bool
{
