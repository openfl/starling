...
class Pool
{
    private static var sPoints:Array<Point> = new Array<Point>();
    private static var sPoints3D:Array<Vector3D> = new Array<Vector3D>();
    private static var sMatrices:Array<Matrix> = new Array<Matrix>();
    private static var sMatrices3D:Array<Matrix3D> = new Array<Matrix3D>();
    private static var sRectangles:Array<Rectangle> = new Array<Rectangle>();
